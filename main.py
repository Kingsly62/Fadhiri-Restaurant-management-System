...
root.title('Restaurant Management System created by Clinton Makori')
...
labelTitle=Label(topFrame,text='Fadhiri Restaurant Management System',font=('arial',30,'bold'),fg='yellow',bd=9,
                 bg='red4',width=51)
